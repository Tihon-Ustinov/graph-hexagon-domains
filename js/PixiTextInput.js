...
PixiTextInput.prototype.onKeyEvent = function(e) {
	...
	if (e.type == "keypress") {
		...
		this.trigger(this.change.bind(this), e);
	}
...
PixiTextInput.prototype.updateCaretPosition = function() {
	...
	//Добавил "+ this.children[2].getGlobalPosition().x" для установки каретки на место самого объекта
	this.caret.position.x = this.textField.context.measureText(sub).width + this.children[2].getGlobalPosition().x;
}
